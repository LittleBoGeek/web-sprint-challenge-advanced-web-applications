...
Tokens are issued in exchange for correct login credentials. They're part of how a server can verify that the login information is accurate and the user is authorized. 

2. What steps can you take in your web apps to keep your data secure?

Using authentication allows you to use protected routes to make sure that only people who are authorized can access private information.

3. Describe how web servers work.
They return resources and responses to requests we send them. Some resources require correct credentials, which in turn result in the server sending back a token that allows us to access the protected resources. 
...
- [S ] Add your team lead as collaborator on Github
